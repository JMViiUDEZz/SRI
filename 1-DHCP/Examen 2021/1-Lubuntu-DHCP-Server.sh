...
#####--------------VMNet2 172.8.0.0--------------#####
echo 'subnet 172.8.0.0 netmask 255.255.254.0 {'     >> /etc/dhcp/dhcpd.conf 
echo '  range 172.8.0.101 172.8.1.254;'             >> /etc/dhcp/dhcpd.conf 
...
echo '  hardware ethernet 00:11:22:33:44:08;'       >> /etc/dhcp/dhcpd.conf 
echo '  fixed-address 172.8.0.99;'                  >> /etc/dhcp/dhcpd.conf 
echo '}'                                            >> /etc/dhcp/dhcpd.conf
